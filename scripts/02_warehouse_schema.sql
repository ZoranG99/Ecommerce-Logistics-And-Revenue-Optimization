...
-- 1. Load Geolocation
COPY geolocation FROM 'D:\Data_Science\Projects\Portfolio_Projects\Ecommerce-Logistics-And-Revenue-Optimization\data\processed\geolocation.csv' 
WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');

-- 2. Load Customers
COPY customers FROM 'D:\Data_Science\Projects\Portfolio_Projects\Ecommerce-Logistics-And-Revenue-Optimization\data\processed\customers.csv' 
WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');

-- 3. Load Sellers
COPY sellers FROM 'D:\Data_Science\Projects\Portfolio_Projects\Ecommerce-Logistics-And-Revenue-Optimization\data\processed\sellers.csv' 
WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');

-- 4. Load Products
COPY products FROM 'D:\Data_Science\Projects\Portfolio_Projects\Ecommerce-Logistics-And-Revenue-Optimization\data\processed\products.csv' 
WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');

-- 5. Load Orders
COPY orders FROM 'D:\Data_Science\Projects\Portfolio_Projects\Ecommerce-Logistics-And-Revenue-Optimization\data\processed\orders.csv' 
WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');

-- 6. Load Order Items
COPY order_items FROM 'D:\Data_Science\Projects\Portfolio_Projects\Ecommerce-Logistics-And-Revenue-Optimization\data\processed\order_items.csv' 
WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');

-- 7. Load Order Payments
COPY order_payments FROM 'D:\Data_Science\Projects\Portfolio_Projects\Ecommerce-Logistics-And-Revenue-Optimization\data\processed\order_payments.csv' 
WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');

-- 8. Load Order Reviews
COPY order_reviews FROM 'D:\Data_Science\Projects\Portfolio_Projects\Ecommerce-Logistics-And-Revenue-Optimization\data\processed\order_reviews.csv' 
WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
